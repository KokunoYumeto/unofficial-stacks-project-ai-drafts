"""Read-only, dynamic configured-source checks for a future root-issued R50 candidate.
...
def main():
    ...
    require(config["candidate_id"] == "stacks-errata-a04446e-r50", "Wrong candidate")
