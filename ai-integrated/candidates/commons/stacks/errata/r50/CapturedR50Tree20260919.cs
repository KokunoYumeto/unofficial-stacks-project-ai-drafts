...
public sealed class CapturedR50Tree20260919 : IDisposable {
    ...
    public CapturedR50Tree20260919(string exe,string[] arguments,string cwd,string outPath,string errPath) {
