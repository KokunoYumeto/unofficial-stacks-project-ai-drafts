...
ROOT = helpers.PROD
BASE = helpers.BASE
CURRENT = '34349c2d88eb9b3e6690e705c9adf7a3d4fa3638'
HASHES = {
    'topology.tex': 'C6BAC8DCF8AD96DC47416BF34CB45BA4A10B894E40D67D3E1FA68D8EF0D9F872',
    'introduction.tex': '43ABD6493BF48325878D6573966E97025770D4B4E12DB1DDA31DA7FD181D4ACF',
}
...
def main():
    ...
    p.add_argument('--source', choices=HASHES, default='topology.tex')
