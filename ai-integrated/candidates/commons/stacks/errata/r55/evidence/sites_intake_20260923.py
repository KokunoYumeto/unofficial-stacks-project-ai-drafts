...
ROOT = helpers.PROD
BASE = helpers.BASE
CURRENT = '35a01332d8714a2012c004bb161cf38f047c0119'
HASHES = {'sites.tex': '07AE4690C2D8EB6873837D3D14A37F07408BB14F9E0BE6077ED570C220B1845D'}
...
def main():
    ...
    p.add_argument('--source', choices=HASHES, default='sites.tex')
