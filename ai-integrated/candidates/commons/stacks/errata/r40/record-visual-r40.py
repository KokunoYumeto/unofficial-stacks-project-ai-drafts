"""Record the already-performed bounded R40 render and visual review.
...
PRIVATE = (
    ...
    / "03_projects/language_management/cjk/03_working_translations/"
      "stacks_cjk_20260821/canon/private_evidence/errata-r40-20260905/render"
)
...
def main() -> int:
    ...
    raw = {
        "schema": "stacks-r40-bounded-visual-review/v1",
        ...
        "method": (
            ...
            "then direct individual inspection of twenty existing 180-dpi renders: "
            "all eight correction-sensitive pages and all twelve pages carrying "
        ...
        "checks": {
            ...
            "correction_sensitive_pages": "All edited prose and formulas on pages 64,65,67,68,70,71,72,73 are readable and geometrically intact.",
    ...
    aggregate = {
        "schema": "stacks-r40-visual-adjudication/v1",
        ...
        "reviews": [
            {
                **evidence(raw_path),
                "page_start": 1,
                "page_end": 93,
                "method": "Six contact sheets cover all 93 pages; twenty individual 180-dpi correction-sensitive and diagnostic pages were also inspected.",
            }
        ],
        "caveats": [
    ...
    stage = {
        "schema": "stacks-r40-build-render-stage-v1",
        ...
        "render": {
            "path": "canon/private_evidence/errata-r40-20260905/render/render-manifest.json",
            "bytes": manifest_path.stat().st_size,
            "sha256": sha(manifest_path),
        ...
        "operational_findings": [
            ...
            "The complete 93-page contact-sheet review and all twenty enlarged sensitive/diagnostic page reviews found no blocking visual defect.",
        ],
