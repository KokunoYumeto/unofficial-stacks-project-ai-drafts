...
public sealed class CapturedR49Tree20260913 : IDisposable {
    ...
    public CapturedR49Tree20260913(string exe,string[] arguments,string cwd,string outPath,string errPath) {
