"""Read-only, dynamic configured-source checks for a future root-issued R49 candidate.
...
def main():
    ...
    require(config["candidate_id"] == "stacks-errata-a04446e-r49", "Wrong candidate")
