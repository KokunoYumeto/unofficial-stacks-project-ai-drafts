"""Reproduce one R51 prior/corrected chapter proof from the complete bundled inputs."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    p.add_argument('--chapter',choices=['sets','schemes','homology','algebra'],required=True)
