"""Append-only R42 finalization; every stage fails closed."""
...
def mechanical() -> dict:
    ...
    assert len(mapping["operations"]) == 12
    ...
    report = {
        "schema": "stacks-r42-final-mechanical-validation-v1",
        "passed": True,
...
def prepare() -> dict:
    ...
    report = {
        "schema": "stacks-r42-final-stage-snapshot-v1",
