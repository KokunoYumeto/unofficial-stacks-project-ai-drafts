...
ROOT = helpers.PROD
BASE = helpers.BASE
CURRENT = '4fddc4a808dc08f74755ac2327e9e9547bb4501f'
HASHES = {'stacks.tex': 'CA374CB00B1C71ACF10E30FAEF293108D079258211D935FE0D4ADD1477634BA9'}
...
def main():
    ...
    p.add_argument('--source', choices=HASHES, default='stacks.tex')
