"""Append-only R41 finalization; every stage fails closed."""
...
def mechanical() -> dict:
    ...
    assert len(mapping["operations"]) == 6
    ...
    report = {
        "schema": "stacks-r41-final-mechanical-validation-v1",
        "passed": True,
...
def visual_receipts() -> list[dict]:
    ...
    assert len(raw["viewed_high_resolution_artifacts"]) == 15
...
def prepare() -> dict:
    ...
    report = {
        "schema": "stacks-r41-final-stage-snapshot-v1",
...
def seal() -> dict:
    ...
    manifest = {
        ...
        "source_closure": {"enumerated": True, "expected_units": 6, "manifested_units": 6, "complete": True},
