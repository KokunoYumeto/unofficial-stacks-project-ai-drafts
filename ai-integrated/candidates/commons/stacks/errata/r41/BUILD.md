# R41 build and replay recipe

1. Run `python pipeline_r41.py --materialize` once against the active R41
...
4. Run `finalize_r41.py mechanical`, `prepare`, independent final validation,
   `finalize_r41.py seal`, and `check-manifest.py`, in that order.
