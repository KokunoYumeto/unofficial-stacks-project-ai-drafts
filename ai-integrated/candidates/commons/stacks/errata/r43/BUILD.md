# R43 build and replay recipe

1. Run `python pipeline_r43.py --materialize` once against the active R43
...
4. Run `finalize_r43.py mechanical`, `prepare`, independent final validation,
   `finalize_r43.py seal`, and `check-manifest.py`, in that order.
