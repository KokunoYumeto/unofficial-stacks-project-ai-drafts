"""Record the already-performed bounded R43 render and visual review.
...
def main() -> int:
    ...
    raw = {
        "schema": "stacks-r43-bounded-visual-review/v1",
    ...
    aggregate = {
        "schema": "stacks-r43-visual-adjudication/v1",
    ...
    stage = {
        "schema": "stacks-r43-build-render-stage-v1",
        ...
        "render": {
            "path": "canon/private_evidence/errata-r43-20260905/render/render-manifest.json",
            "bytes": manifest_path.stat().st_size,
            "sha256": sha(manifest_path),
